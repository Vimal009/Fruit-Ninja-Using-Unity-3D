...
public class Blade : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Wenn die Linke Maus-Taste geklickt wird, wird der Collider aktiviert damit die Fruits zerschnitten werden k�nnen
            // Au�erdem wird der TrailRenderer aktiviert, damit man die Blade sehen kann
